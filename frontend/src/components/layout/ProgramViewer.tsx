...
export function ProgramViewer() {
  ...
  return (
    <main className="flex-1 overflow-y-auto p-6 space-y-6">
      ...
      {program.coach_approved && program.coach_edited && !program.uploaded_to_teambuildr && totalEditCount > 0 && (
        <div className="rounded-lg border border-amber-500/30 bg-amber-500/5 px-3 py-2 text-xs text-amber-400 flex items-center gap-2">
          ...
          Program edited after upload — re-upload to TeamBuildr required
        </div>
      )}
